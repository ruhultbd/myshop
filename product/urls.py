...
from .views import Products, TaggedProducts, CategoryProducts, SearchProducts, productDetails, AddToCartView, CartsView, CheckoutView
...
urlpatterns = [
    ...
    path('checkout', CheckoutView.as_view(), name="product.checkout"),
